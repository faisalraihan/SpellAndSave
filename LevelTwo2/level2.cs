...
namespace LevelTwo2
{
    public partial class levelTwo : Form
    {
        ...
        public levelTwo()
        {
            ...
            // bonus ghost timer initialize
            bonusGhostTimerMethod();
        ...
        private void levelOne_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0, top = 92; i < 3; i++, top = top + 55)
            {
                ...
                lifepic[i].Image = LevelTwo2.Properties.Resources.heart;
        ...
        private void ghostPictureboxes()
        {
            ...
            for (int i = 0, top = 750, left = 60; i < 3; i++, top += 60, left += 150)
            {
                ...
                Secondghostpics[i].Image = LevelTwo2.Properties.Resources.g2;
            ...
            for (int i = 0, top = 50, left = 90; i < 3; i++, top += 60, left += 150)
            {
                ...
                Thirdghostpics[i].Image = LevelTwo2.Properties.Resources.ghost1;
