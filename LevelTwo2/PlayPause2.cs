...
namespace LevelTwo2
{
    public partial class levelTwo : Form
    {
        ...
        private void checkTimer()
        {
            ...
            {
                timerlist.Remove(bonusGhostTimer);
            }
        ...
        private void playpause_Click(object sender, EventArgs e)
        {
            ...
            if (playPause == 0)
            {
                playpause.Image = LevelTwo2.Properties.Resources.play;
            ...
            {
                playpause.Image = LevelTwo2.Properties.Resources.Pause;
