...
namespace LevelTwo2
{
    public partial class levelTwo : Form
    {
        ...
        //Timer for bonus ghost
        Timer bonusGhostTimer = new Timer();
        ...
        // functionality for bonus ghost timer
        private Timer bonusGhostTimerMethod()
        {
            bonusGhostTimer.Interval += 100;
            bonusGhostTimer.Tick += new EventHandler(bonusGhostTimer_Tick);
            bonusGhostTimer.Start();

            return bonusGhostTimer;
        }
