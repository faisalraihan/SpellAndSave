...
namespace LevelOne1
{
    public partial class levelOne : Form
    {
        ...
        private void spellText_TextChanged(object sender, EventArgs e)
        {
           ...
           else if (spellText.Text == thirdSpell)
           {
            ...
            else if (spellText.Text == bossSpell1)
            {
                ...
                bossPicture.Image = LevelOne1.Properties.Resources.boss2;
                scoreUpdate();
                spellText.Clear();
                count = 1;
                bossMovement();
        ...
        public void changePlayerAnimation()
        {
            if (change == 1)
            {
                player.Image = LevelOne1.Properties.Resources.Player1;
            }
            else if(change==0)
            {
                player.Image = LevelOne1.Properties.Resources.Player2;
            }
        }
